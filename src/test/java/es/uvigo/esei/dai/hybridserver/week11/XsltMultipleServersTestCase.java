...
public class XsltMultipleServersTestCase
extends AbstractGetMultipleServersTestCase {
	...
	public final void testGetLocales(int serverIndex) throws IOException {
		final String[] uuids = getLocalXsltUUIDs(serverIndex);
		final String[] contents = getLocalXsltFiles(serverIndex);
	...
	public final void testGetRemotes(int serverIndex) throws IOException {
		final String[] uuids = getRemoteXsltUUIDs(serverIndex);
		final String[] contents = getRemoteXsltFiles(serverIndex);
